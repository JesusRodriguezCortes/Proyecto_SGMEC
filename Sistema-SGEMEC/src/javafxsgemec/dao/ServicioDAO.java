        ...
        if(conexionBD != null){
            try {
                ...
                PreparedStatement getServicio = conexionBD.prepareStatement(sqlQuery);
                    getServicio.setString(1, newServicio.getNombreServicio());
        ...
        if(conexionBD != null){
            try {
                ...
                getServicio.setInt(1, idServicio);
                    servicioBD.setNombreServicio(resultSet.getString("nombre"));
            } catch (SQLException e) {
                response.setMessage(e.getMessage());
            ...
            try {
                ...
                while(resultSet.next()){
                    Servicio newServicio = new Servicio();
                        ...
                        newServicio.setNombreServicio(resultSet.getString("nombre"));
        ...
        if(conexionBD != null){
            try {
                ...
                PreparedStatement setServicio = conexionBD.prepareStatement(sqlQuery);
                    setServicio.setString(1, editServicio.getNombreServicio());
