...
public class RolDAO {
    public static Rol getRol(int idRol) throws SQLException{
        ...
        if(conexionBD != null){
            try {
                String sqlQuery = "SELECT idRol, nivelAcceso FROM rol " +
                                  "WHERE idRol = ?; ";
                ...
                getRol.setInt(1, idRol);
                    rolBD.setIdRol(resultSet.getInt("idRol"));
    ...
    public static ArrayList<Rol> getRoles() throws SQLException{
        ...
        if(conexionBD != null){
            try {
                ...
                while(resultSet.next()){
                    Rol newRol = new Rol();
                        newRol.setIdRol(resultSet.getInt("idRol"));
