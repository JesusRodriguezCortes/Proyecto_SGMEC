...
public class DiagnosticoDAO {
    public static ResultOperation createDiagnostico(Diagnostico newDiagnostico) throws SQLException{
        ...
        if(conexionBD != null){
            try {
                ...
                System.out.println(e.getMessage()+"errrorrrrrrrr");
    ...
    public static Diagnostico getDiagnostico(int idDispositivo) throws SQLException{
        ...
        if(conexionBD != null){
            try {
                ...
                getDiagnostico.setInt(1, idDispositivo);
