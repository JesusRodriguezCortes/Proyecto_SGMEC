...
public class PedidoRefaccionDAO {
    ...
    public static ResultOperation registrarPedidoRefaccion(PedidoRefaccion nuevoPedido) throws SQLException{
        ...
        if(conexionBD != null){
            try {
                ...
                if(numeroFilas > 0){
                    ...
                    respuesta.setMessage("Pedido "+ nuevoPedido.getNumeroPedido() +" agregado correctamente.");
                    respuesta.setNumberRowsAffected(numeroFilas);
                }else{
                    respuesta.setMessage("No se pudo registrar la información del pedido.");
                } 
    ...
    public static PedidoRefaccion ObtnenerPedidoRefaccion(String numeroPedido){
        ...
        if(conexionBD != null){
            try {
                ...
                ResultSet resultadoConsulta = configurarConsulta.executeQuery();
                while(resultadoConsulta.next()){
                    pedidoRefaccion.setIdPedidoRefaccion(resultadoConsulta.getInt("idPedidoRefacciones"));
